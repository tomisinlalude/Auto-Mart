...
//   userCredentialsWithWrongPassword, userCredentialsWithNonMatchingPasswords, nonExistingUser,
...
//         expect(res.body.message).to.eql('This is not valid');
//         done();
//       });
//   });
...
//         expect(res.body.data).to.have.keys('token', 'id', 'firstName', 'lastName', 'email', 'phoneNumber');
